...
// Debug output
std::cout << "Graph.h included successfully" << std::endl;

Graph::Graph() {}

void Graph::build_from_file(const std::string& filename) {
...
std::vector<int> Graph::get_recommendations(int vertex, int num_recommendations) const {
...
std::vector<std::vector<int>> Graph::detect_communities() const {
    std::unordered_set<int> visited;
